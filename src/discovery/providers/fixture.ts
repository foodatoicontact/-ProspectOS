...
export const GENERIC_FIXTURE_COMPANIES:FixtureCompany[]=[
 ...
 homepage:'<html><head><title>TEST — Nova Assistance</title></head><body><h1>Nova Assistance</h1><p>Nova Assistance accompagne les PME de services dans le traitement de leurs demandes entrantes.</p><p>Contactez notre équipe au 05 00 00 00 12 ou via notre formulaire de contact.</p><a href="/contact">Contact</a></body></html>',
