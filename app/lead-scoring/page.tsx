...
const page=getSeoPage('lead-scoring');
export const metadata:Metadata={
  title:{absolute:page.title},
  description:page.description,
  alternates:{canonical:`${SITE_URL}/lead-scoring`},
  openGraph:{title:{absolute:page.title},description:page.description,url:`${SITE_URL}/lead-scoring`,type:'website',locale:'fr_FR',siteName:'ProspectOS'},
